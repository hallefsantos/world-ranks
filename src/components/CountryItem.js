...
const CountryItem = ({ country }) => {
    return (
        ...
        >
            <div 
                className="cursor-pointer relative pl-20 sm:pl-5 p-3 sm:p-5 flex flex-col sm:flex-row sm:items-center w-full bg-white hover:bg-gray-700 shadow-sm hover:shadow-md rounded-lg transform translate-y-0 hover:-translate-y-1 transition duration-200 text-sm md:text-base text-gray-700 hover:text-white space-y-1 sm:space-y-0"
            >
